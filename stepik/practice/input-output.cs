...
public class InputOutput
{
    public static void Main()
    {
        ...
        // Пример 3: Считывание и вывод трёх строк (точное повторение ввода пользователя)
        // Example 3: Reading and printing three lines (exact repetition of user input)
        ...
        // Пример 4: Считывание и вывод трёх строк в обратной последовательности
        // Example 4: Read and output three lines in reverse order
        Console.WriteLine("Введите три строки: ");                 // Подсказка пользователю / Prompt the user
